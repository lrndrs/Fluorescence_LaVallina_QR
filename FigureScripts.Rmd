...
df_climate2$maxdr <- -1
for (l in 1:5){
  df_climate2$maxdr[df_climate2$loc==locs[l]] <- df_climate2 %>% filter(loc==locs[l]) %>% select(driprate) %>% max(na.rm=TRUE)
}

df_climate2$normdr <- df_climate2$driprate/df_climate2$maxdr
ggplot(df_climate2,aes(x=lubridate,y=normdr,colour=loc)) + geom_line()
...
C4_low <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4) 

C2_low <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_low <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_low <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_low <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 

C4_high <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4,loc) 

C2_high <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_high <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_high <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_high <- df_climate2 %>% filter(loc %in% c("GLO")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 
...
C4_low <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4) 

C2_low <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_low <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_low <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_low <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 

C4_high <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4,loc) 

C2_high <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_high <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_high <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_high <- df_climate2 %>% filter(loc %in% c("SKY")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 
...
C4_low <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4) 

C2_low <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_low <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_low <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_low <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 

C4_high <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4,loc) 

C2_high <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_high <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_high <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_high <- df_climate2 %>% filter(loc %in% c("FOR")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 
...
C4_low <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4) 

C2_low <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_low <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_low <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_low <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_min(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 

C4_high <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.4,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.4,loc) 

C2_high <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.2,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.2,loc) 

C3_high <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.3,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.3,loc) 

C1_high <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.1,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.1,loc) 

C5_high <- df_climate2 %>% filter(loc %in% c("PLA")) %>%
  dplyr::select(T_10d,Comp.5,loc) %>% group_by(loc) %>% slice_max(order_by = T_10d,n=floor(length(mm)/2)) %>% dplyr::select(Comp.5,loc) 
...
mm <- levels(as.factor(df_climate2$P_10d))
...
mm <- levels(as.factor(df_climate2$normdr[df_climate2$loc %in% locs]))
